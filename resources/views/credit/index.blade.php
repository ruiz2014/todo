                                ...
                                <tbody>
                                    @foreach ($attentions as $attention)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-primary xs-margin" href="{{ route('credits.show', $attention->customer_id) }}"><ion-icon name="eye"></ion-icon></a>
                                                <a class="btn btn-sm btn-success btn-credit" id="{{ $attention->customer_id }}" href="" data-bs-toggle="modal" data-bs-target="#exampleModal3"><ion-icon name="create"></ion-icon></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
        ...
        <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModal3Label" >
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('credits.total') }}"  role="form">
                        @csrf 
