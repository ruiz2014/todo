<table class="border" WIDTH="100%" cellspacing="0">
			<thead  style="border-bottom:1px solid #aaa3a6">
				<tr>
					<th style="padding:4px 1px;color:#000;font-size:11px;">NOMBRE </th>
					<th style="padding:4px 1px;color:#000;font-size:11px;">DESCRIPCION</th>
					<th style="padding:4px 1px;color:#000;font-size:11px;">IMAGEN</th>
					<th style="padding:4px 1px;color:#000;font-size:10px;">CANT</th>
					<th style="padding:4px 1px;color:#000;font-size:10px;">P. UNIT.</th>
					<th style="padding:4px 1px;color:#000;font-size:10px;">IMPORTE</th>
				</tr>
			</thead>
			<tbody class="details">
		...
		@foreach($temps as $item)
				<tr>
					...
					<td><img style="width:50px;" src="{{ asset('/'.$item->img) }}" alt=""></td>
	...
	?>
				...
				<tr>
					<td colspan=4 style="border:none;padding:3px 1px;"></td>
